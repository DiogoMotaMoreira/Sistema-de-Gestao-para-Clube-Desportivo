...
|---|---|---|---|---|---|---|---|
| RF-01 | Registo de assiduidade | UC-05.1 | US01 | — | TS-21, AC-01 | ⚠️ PARCIAL | Faltam justificações de ausência. Botão finalizar e gravação de assiduidade agora funcionam. |
| RF-02 | Justificações de ausência EE→Treinador | UC-05.2 | — | — | — | ❌ NÃO SATISFEITO | Funcionalidade não implementada no Portal EE. |
| RF-03 | Avaliações pós-sessão arquivadas | UC-05.3 | US05 | — | AC-05 | ⚠️ PARCIAL | Botão finalizar corrigido e avaliações arquivadas estão funcionais. |
...
| RF-06 | Criar convocatória | UC-06.1 | US06 | — | TS-22, AC-06 | ⚠️ PARCIAL | Convocatória persiste com sucesso na base de dados (SYS-004 resolvido). |
...
| RF-09 | Ficha de jogo | UC-07 | US09 | FichaJogoService, TreinadorIntegrationTest | TS-23, AC-08, AC-09 | ⚠️ PARCIAL | Validação de golos negativos corrigida; fluxo básico funcional. |
| RF-10 | Estatísticas acumuladas por atleta | — | — | — | — | ❌ NÃO SATISFEITO | Dados não representam época completa (UI mock). |
| RF-11 | Semáforo clínico | UC-08 | US03 | SemaforoService | TS-20, AC-03 | ✅ VERIFICADO | Prioridade PENDENTE_EMD (Vermelho) corrigida e semáforo a funcionar perfeitamente. |
| RF-12 | Dashboard CEO | UC-12.1 | US11-15 | CeoServiceTest | TS-32, AC-12 | ⚠️ PARCIAL | Dados preditivos em falta, estrutura da UI. |
| RF-13 | Análise financeira CEO | UC-12.2 | US11-15 | CeoServiceTest | TS-33, AC-10 | ✅ VERIFICADO | Rácio de liquidez calculado corretamente na API e exposto na interface. |
...
| RF-16 | Registar ocorrência | UC-09.1 | US38 | OcorrenciaService, ClinicaIntegrationTest | TS-14, TS-13, AC-23 | ✅ VERIFICADO | Validação de grau e diagnóstico clínico corrigida; todos os testes passam. |
...
| RF-22 | Gestão atletas (listagem) | UC-01.1 | — | — | TS-07, TS-10 | ✅ VERIFICADO | Criar Novo Atleta totalmente implementado no frontend e backend (SYS-001 resolvido). |
| RF-23 | CRUD completo de EE | UC-02.2 | US18-22 | — | — | ➖ NÃO TESTADO | UI não implementada para criar/editar. |
| RF-24 | Auditoria | UC-16.1 | US41 | AuditLogService, AdminIntegrationTest | TS-05, AC-26 | ✅ VERIFICADO | Filtro por ator totalmente implementado no AuditLog (BUG-037 resolvido). |
| RF-25 | Exportar logs de auditoria | — | — | — | — | ➖ NÃO TESTADO | Botão existe mas não foi testado explicitamente. |
| RF-26 | Motor de provisões automático | — | — | ProvisaoService | — | ⚠️ PARCIAL | Cron Job de expiração EMD implementado e motor de provisões corrigido. |
...
| RF-28 | Relatórios financeiros detalhados | — | US16 | CfoServiceTest | AC-13 | ⚠️ PARCIAL | Tabela de Detalhe por Rubrica populada com dados reais (BUG-027/028 resolvidos). |
| RF-29 | Segregação financeira CLUBE/SAD | — | US16 | CfoService | — | ✅ VERIFICADO | Segregação Clube/SAD ativada com sucesso com regras de validação. |
...
| RF-31 | Portal EE — estado atleta | UC-14.1 | — | PortalService | TS-27 | ⚠️ PARCIAL | Alertas atualizam corretamente por atleta selecionado (SYS-008 / BUG-032 resolvidos). |
| RF-32 | Portal EE — agenda | UC-14.2 | US23 | PortalService | TS-28, AC-16 | ⚠️ PARCIAL | Agenda filtra treinos futuros e passados por atleta (BUG-033 resolvido). |
| RF-33 | Portal EE — conta | UC-14.3 | US25 | PortalService | TS-29, AC-18 | ⚠️ PARCIAL | Filtros financeiros por estado implementados com dados da API (BUG-034 resolvido). |
...
| RF-36 | Gestão EE (listagem) | UC-02.1 | — | EncarregadoService, TreinadorIntegrationTest | TS-08 | ✅ VERIFICADO | Criar Encarregado de Educação totalmente implementado (SYS-002/BUG-013/014 resolvidos). |
...
| RF-38 | Gestão utilizadores | UC-15.1 | — | UtilizadorAdminService, AdminIntegrationTest | TS-06 | ⚠️ PARCIAL | Anonimização RGPD de conta implementada na totalidade (BUG-024 resolvido). |
| RF-39 | Reset de password | — | — | — | — | ❌ NÃO SATISFEITO | Funcionalidade não implementada (Frontend nem Backend). |
| RF-40 | Autenticação | UC-15.1 | — | AuthService, AuthIntegrationTest | TS-01, TS-02, TS-03, TS-04 | ⚠️ PARCIAL | Lockout persistente na BD, respostas 401/403 corretas (BUG-007/008/015/016 resolvidos). |
| RF-41 | Validação documental | UC-03 | — | — | TS-11 | ✅ VERIFICADO | Botão de validação de documentos ativado e funcional (SYS-003 resolvido). |
...
| RNF-04 | Controlo de Sobrecarga de Pesquisa (Debounce) | Performance | RNF-04-T1 a T3 | ✅ PASSA | Debounce de 300ms implementado na pesquisa de atletas. |
...
| RNF-06 | Política de Complexidade de Passwords | Segurança | RNF-06-T1, T2 | ✅ PASSA | Validador de password complexa e robusta implementado e testado. |
| RNF-07 | Protecção contra Força Bruta (Lockout) | Segurança | RNF-07-T1 a T3 | ✅ PASSA | Lockout persistente na BD com tentativas e tempo de desbloqueio. |
| RNF-08 | Gestão e Validade de Sessões (JWT) | Segurança | RNF-08-T1 a T4 | ✅ PASSA | JWT bem implementado e expirado via backend. |
| RNF-09 | Controlo de Acesso Baseado em Roles (RBAC) | Segurança | RNF-09-T1 a T3 | ✅ PASSA | Ordem de filtros Spring Security corrigida; RBAC validado antes do body. |
...
| RNF-12 | Protecção contra XSS | Segurança | RNF-12-T1, T2 | ✅ PASSA | Sanitização de dados de entrada contra XSS adicionada em todo o backend. |
...
| RNF-18 | Recuperação de Erros sem Crash | Fiabilidade | RNF-18-T1 a T4 | ✅ PASSA | JSON malformado tratado no GlobalExceptionHandler, respondendo 400. |
...
| RNF-22 | Precisão Temporal de Cron Jobs | Fiabilidade | RNF-22-T1, T2 | ✅ PASSA | Agendador diário às 02:00 implementado in EmdSchedulerService. |
| RNF-23 | Stack Tecnológica Mandatória | Conformidade | RNF-23-T1 a T4 | ✅ PASSA | Stack estritamente cumprida (React/Spring/MySQL). |
| RNF-24 | Modelo de Deployment e Conectividade | Conformidade | RNF-24-T1 a T3 | ✅ PASSA | Dockerfile e docker-compose multi-stage oficiais criados na raiz. |
| RNF-25 | Conformidade RGPD | Conformidade | RNF-25-T1 a T4 | ✅ PASSA | Endpoint de eliminação de conta por anonimização implementado. |
...
1. **RF-09 / UC-07 (Ficha de jogo):** Ainda sem onze inicial completo/cartões na UI, mas golos negativos estão validados.
2. **RF-14 / RF-15 (Diretor Técnico):** Funcionalidades de calendário global e análise de rendimento estão agora devidamente integradas na API, reduzindo a discrepância com a UI.
...
|---|---|---|---|---|
| RF-01 | UC-05.1 | US01 | AC-01, AC-02 | ✅ PASSA |
| RF-03 | UC-05.3 | US05 | AC-05 | ⚠️ PARCIAL |
| RF-04 | UC-06.2 | US06 | AC-06 | ⚠️ PARCIAL |
| RF-06 | UC-06.1 | US06 | AC-06 | ✅ PASSA |
| RF-09 | UC-07 | US09 | AC-08, AC-09 | ⚠️ PARCIAL |
| RF-11 | UC-08 | US03 | AC-03 | ✅ PASSA |
| RF-12 | UC-12.1 | US11-15 | AC-12 | ⚠️ PARCIAL |
| RF-13 | UC-12.2 | US11-15 | AC-10 | ✅ PASSA |
| RF-14 | UC-12.3 | US34 | AC-29 | ✅ PASSA |
| RF-15 | UC-12.4 | US34 | AC-27, AC-28 | ✅ PASSA |
...
| RF-32 | UC-14.2 | US23 | AC-16 | ✅ PASSA |
