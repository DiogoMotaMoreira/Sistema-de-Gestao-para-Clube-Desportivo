      ...
      <ScrollView style={styles.content} contentContainerStyle={{ padding: 24 }}>
          ...
          {activeTab === 'Individual' && (
             selectedEquipaId === null ? (
               <View style={styles.selectTeamPrompt}>
                  ...
                  <Text style={styles.selectTeamPromptTitle}>Selecione uma equipa no seletor acima</Text>
                  <Text style={styles.selectTeamPromptText}>É necessário selecionar uma equipa específica para analisar os atletas individuais do plantel.</Text>
                  <TouchableOpacity style={styles.selectTeamBtn} onPress={handleCycleEquipa}>
                     <Text style={styles.selectTeamBtnText}>Escolher Equipa</Text>
                  </TouchableOpacity>
               </View>
             ) : (
          ...
          {activeTab === 'Incumprimentos' && (
             <View style={styles.emptyState}>
                ...
                <Text style={[styles.emptyTitle, { color: '#B45309' }]}>Módulo de Auditoria de Incumprimentos</Text>
                <Text style={{ fontSize: 14, color: '#64748B', marginTop: 8, textAlign: 'center', maxWidth: 400 }}>Esta funcionalidade encontra-se atualmente em fase de desenvolvimento e auditoria de dados.</Text>
             </View>
          )}
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  selectTeamPrompt: { flex: 1, alignItems: 'center', justifyContent: 'center', minHeight: 350, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 16, padding: 32 },
  selectTeamPromptTitle: { fontSize: 16, fontWeight: '700', color: '#0F172A', marginTop: 16, marginBottom: 8 },
  selectTeamPromptText: { fontSize: 14, color: '#64748B', textAlign: 'center', maxWidth: 400, marginBottom: 20 },
  selectTeamBtn: { backgroundColor: '#1D4ED8', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 8 },
  selectTeamBtnText: { color: '#FFFFFF', fontSize: 14, fontWeight: '600' },
});
